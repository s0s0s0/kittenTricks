...
const ThemesNavigator = createStackNavigator({
    ['Themes']: ThemesContainer,
}, {
    defaultNavigationOptions: MenuNavigationOptions,
});
const ComponentsNavigator = createStackNavigator({
...
const LayoutsNavigator = createStackNavigator({
...
const AppNavigator = createStackNavigator(Object.assign({ ['Home']: MenuNavigator }, AuthNavigationMap, SocialNavigationMap, ArticlesNavigationMap, MessagingNavigationMap, DarhboardsNavigationMap, EcommerceNavigationMap), {
    headerMode: 'screen',
