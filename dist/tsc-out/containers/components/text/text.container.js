...
import { C1Text, C2Text, DangerText, H1Text, H2Text, H3Text, H4Text, H5Text, H6Text, InfoText, LabelText, P1Text, P2Text, PrimaryText, S1Text, S2Text, SuccessText, WarningText, } from './showcase';
