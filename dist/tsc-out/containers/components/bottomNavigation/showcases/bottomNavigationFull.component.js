...
export class BottomNavigationFull extends React.Component {
    constructor() {
        super(...arguments);
        this.state = {
            selectedIndex: 0,
    ...
    render() {
        return (<BottomNavigation selectedIndex={this.state.selectedIndex} onSelect={this.onTabSelect}>
...
//# sourceMappingURL=bottomNavigationFull.component.js.map