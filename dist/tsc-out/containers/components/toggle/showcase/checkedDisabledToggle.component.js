...
export const CheckedDisabledToggle = (props) => {
    return (<ToggleShowcaseComponent checked={true} disabled={true} {...props}/>);
};
//# sourceMappingURL=checkedDisabledToggle.component.js.map