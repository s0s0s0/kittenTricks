...
export const ForgotPassword = withStyles(ForgotPasswordComponent, (theme) => ({
    ...
    forgotPasswordLabel: Object.assign({ alignSelf: 'center', marginTop: 24, color: 'white' }, textStyle.headline),
    enterEmailLabel: Object.assign({ alignSelf: 'center', marginTop: 64, color: 'white' }, textStyle.subtitle),
    resetButton: {},
}));
