...
class SignUp2Component extends React.Component {
    constructor() {
        ...
        this.renderPhotoButton = () => {
            const { themedStyle } = this.props;
            return (<Button style={themedStyle.photoButton} activeOpacity={0.95} icon={this.renderPhotoButtonIcon} onPress={this.onPhotoButtonPress}/>);
        };
    }
    render() {
        const { themedStyle } = this.props;
        ...
        <View style={themedStyle.headerContainer}>
          <ProfilePhoto style={themedStyle.photo} resizeMode='center' source={{ uri: 'https://akveo.github.io/eva-icons/fill/png/128/person.png' }} button={this.renderPhotoButton}/>
        </View>
        ...
        <Button style={themedStyle.signInButton} textStyle={themedStyle.signInText} appearance='ghost' activeOpacity={0.75} onPress={this.onSignInButtonPress}>
...
export const SignUp2 = withStyles(SignUp2Component, (theme) => ({
    ...
    signInText: Object.assign({ color: theme['text-hint-color'] }, textStyle.subtitle),
}));
