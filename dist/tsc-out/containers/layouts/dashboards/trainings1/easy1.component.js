...
import { List, Text, } from '../../../../../node_modules/react-native-ui-kitten/ui';
...
class Easy1Component extends React.Component {
    constructor() {
        ...
        this.renderPager = () => {
            const { themedStyle } = this.props;
            return (<View>
        <List style={themedStyle.pagerContainer} horizontal={true} renderItem={this.renderPagerCard} data={this.props.exercises} showsHorizontalScrollIndicator={false} onScroll={this.onExerciseListScroll}/>
        ...
        this.renderListCard = (info) => {
            return (<TrainingCard1 style={this.props.themedStyle.listCard} training={info.item} index={info.index} onDetails={this.onTrainingDetails}/>);
        };
    }
    render() {
        const { themedStyle, exercises } = this.props;
...
export const Easy1 = withStyles(Easy1Component, (theme) => ({
    ...
    pagerLabel: Object.assign({ marginVertical: 16 }, textStyle.paragraph),
    pagerCard: {
        width: 226,
    },
    listCard: {
...
//# sourceMappingURL=easy1.component.js.map