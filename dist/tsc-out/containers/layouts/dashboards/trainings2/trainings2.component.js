...
import { TrainingCard3, } from '@src/components/trainings/trainingCard3.component';
class Trainings2Component extends React.Component {
    constructor() {
        ...
        this.renderCard = (info) => {
            return (<TrainingCard3 style={this.props.themedStyle.item} training={info.item} index={info.index} onDetails={this.onTrainingDetails} onTiming={this.onTrainingTiming} onEnergy={this.onTrainingEnergy}/>);
        };
    }
    render() {
...
//# sourceMappingURL=trainings2.component.js.map