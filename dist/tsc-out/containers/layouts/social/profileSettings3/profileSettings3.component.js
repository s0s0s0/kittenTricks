...
class ProfileSettings3Component extends React.Component {
    ...
    render() {
        ...
        <View style={themedStyle.photoSection}>
          <ProfilePhoto style={themedStyle.photo} shape='rounded' source={profile.photo.imageSource} button={this.renderPhotoButton}/>
        </View>
...
export const ProfileSettings3 = withStyles(ProfileSettings3Component, (theme) => ({
    container: {
        flex: 1,
...
//# sourceMappingURL=profileSettings3.component.js.map