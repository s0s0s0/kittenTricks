...
class LayoutsListItemComponent extends React.Component {
    constructor() {
        super(...arguments);
        this.renderIconElement = (style, theme) => {
            const iconElement = this.props.data.icon(style, theme);
...
export const LayoutsListItem = withStyles(LayoutsListItemComponent, (theme) => ({
    container: {
    ...
    title: Object.assign({ marginTop: 8 }, textStyle.subtitle),
}));
//# sourceMappingURL=layoutsListItem.component.js.map