...
import { ApartmentFacilityList1Item, } from './apartmentFacilityList1Item.component';
class ApartmentFacilityList1Component extends React.Component {
    constructor() {
        super(...arguments);
        ...
        this.renderListItemElement = (item) => {
            return (<ApartmentFacilityList1Item style={this.props.themedStyle.item} onPress={this.onItemPress}>
        {item.title}
...
export const ApartmentFacilityList1 = withStyles(ApartmentFacilityList1Component, (theme) => ({
    container: {
        flexDirection: 'row',
        flexWrap: 'wrap',
    },
...
//# sourceMappingURL=apartmentFacilityList1.component.js.map